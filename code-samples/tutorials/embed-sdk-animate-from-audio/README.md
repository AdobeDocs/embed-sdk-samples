# Adobe Express Embed SDK Animate from Audio tutorial

This sample project demonstrates the Animate from Audio quick action for the Adobe Express Embed SDK.
