# Adobe Express Embed SDK Template Browser concept guide

This sample project is a companion to the [Template Browser](https://developer.adobe.com/express/embed-sdk/docs/guides/concepts/template-browser) concept guide for the Adobe Express Embed SDK.
