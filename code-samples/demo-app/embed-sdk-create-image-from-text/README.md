# Adobe Express Embed SDK Create Image From Text Sample

This sample project demonstrates how to use the Adobe Express Embed SDK's `createImageFromText` method to generate images from text prompts.
